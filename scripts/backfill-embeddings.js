...
const CANDIDATE_BATCH_SIZE = 100; // Process 3 candidates concurrently
const JOB_BATCH_SIZE = 5; // Process 5 jobs concurrently
const MODE = process.env.MODE || 'candidates'; // 'candidates', 'jobs', or 'both'
